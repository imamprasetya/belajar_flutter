...
import 'package:belajar_flutter/tugas_11_12_flutter_crud/view/ud_sinau.dart';
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    if (guruController.text.isEmpty) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(content: Text("Guru Belum Diisi")),
                      );
                      return;
                    }
              ...
              ElevatedButton(
                onPressed: () {
                  context.push(UdSinau());
                },
                child: Text("Lihat Data Pelajaran"),
              ),
              SizedBox(height: 15),
...
FutureBuilder<List<Tugas11Model>> pelajaranWidget() {
  return FutureBuilder<List<Tugas11Model>>(
    ...
    builder: (BuildContext context, AsyncSnapshot snapshot) {
      ...
      final dataSinau = snapshot.data as List<Tugas11Model>;
